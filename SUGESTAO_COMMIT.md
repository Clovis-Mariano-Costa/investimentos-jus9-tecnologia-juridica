...
```txt
feat: atualizar página de investimentos no padrão Jus 9
```

## Description

```txt
Consolida o repertório investimentos-jus9-tecnologia-juridica no Mão na Massa Final da Jus 9, com padrão visual obrigatório, modelo de assinatura com ©, orientações de leitura obrigatória, segurança, classificação de conteúdo e instruções para futuras alterações.
